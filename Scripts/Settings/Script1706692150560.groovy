...
WebUI.click(findTestObject('Object Repository/Page_Dashboard - Mustafa Application/div_H Nikhil Trivedi  Welcome to Dashboard'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard - Mustafa Application/a_Nikhil'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard - Mustafa Application/a_Settings'))

WebUI.scrollToPosition(500, 500)

WebUI.click(findTestObject('Object Repository/Page_Settings - Mustafa Application/button_Close'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard - Mustafa Application/span_Welcome to CorpCarbon'))
