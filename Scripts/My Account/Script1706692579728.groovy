...
WebUI.click(findTestObject('Object Repository/Page_Dashboard - Mustafa Application/a_My Account'))

WebUI.click(findTestObject('Object Repository/Page_My Account - Mustafa Application/h3_My Account'))
